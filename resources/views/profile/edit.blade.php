@extends('layouts.app', ['page' => trans('sidebar.header.user_profile'), 'pageSlug' => 'profile', 'section' => 'users'])
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ trans('user.edit_title') }}</h5>
                </div>
                <form method="post" action="{{ route('profile.update') }}" autocomplete="off">
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-fill btn-primary">{{ trans('button.save') }}</button>
                    </div>
                </form>
            </div>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="title">{{ trans('user.password') }}</h5>
                </div>
                <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                    <div class="card-body">
                        ...
                        <div class="form-group{{ $errors->has('old_password') ? ' has-danger' : '' }}">
                            <label>{{ trans('user.current_password') }}</label>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-fill btn-primary">{{ trans('user.change_password') }}</button>
                    </div>
                </form>
            </div>
        </div>
