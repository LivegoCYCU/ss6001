@extends('layouts.app', ['page' =>  trans('sidebar.header.edit_product'), 'pageSlug' => 'sales', 'section' => 'transactions'])
                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('sales.show', $sale) }}" class="btn btn-sm btn-primary">{{ trans('button.back') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
